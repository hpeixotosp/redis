// ─── Dados de seed atualizados com as correções de escopo de Mayla, Stephani e Karlyana ─────────────────
...
const G = {
  ...
  S02: "a5500002-0000-0000-0000-000000000002", // Stephani -> TRE-SP (Cenário B / Anexo IV)
};
...
export const SEED_DATA = {
  servidores: [
    ...
    },
    {
      ...
      regraTribunal: "TRT21 & TRT6 Saída",
      concluido: false,
      ordem: "4",
    },
    {
      ...
      regraTribunal: "TRE-SP (Cenário B) & TRT2 Concluído",
      concluido: false,
      ordem: "5",
    },
  ],
  ...
  documentos: [
    ...
    // ── 4. TRT21 Entrada + TRT6 Saída (Mayla) ─────────────────────────────────
    ...
    // Documentos da Mayla saindo do TRT6 (como ela já está lá e está saindo, ela entrega os de saída)
